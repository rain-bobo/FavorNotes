...
public class MyPopupWindow extends PopupWindow implements View.OnClickListener {
    ...
    private void initViewSetting(Activity context) {
        ...
        mMenuView = inflater.inflate(R.layout.after_home, null);


        iv_add = (ImageView) mMenuView.findViewById(R.id.dd5);
        iv_add.setOnClickListener(this);

        iv_push_photo = (ImageView) mMenuView.findViewById(R.id.iv_push_myrecord);
        iv_push_photo.setOnClickListener(this);

        iv_push_resale = (ImageView) mMenuView.findViewById(R.id.iv_push_mysetting);
        iv_push_resale.setOnClickListener(this);

        iv_push_resale_faker = (ImageView) mMenuView.findViewById(R.id.iv_push_record_faker);
        iv_push_photo_faker = (ImageView) mMenuView.findViewById(R.id.iv_push_setting_faker);
