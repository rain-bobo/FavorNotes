package com.example.favornotes.adapter;
...
public class AccountAdapter extends BaseAdapter {
    ...
    class ViewHolder{
        ImageView typeIv;
        TextView timeTv,typeTv,moneyTv,reasonTv,nameTv;
        public ViewHolder(View view){
            typeIv = view.findViewById(R.id.item_mainlv_iv);
            typeTv = view.findViewById(R.id.item_mainlv_tv_type);
            nameTv = view.findViewById(R.id.item_mainlv_tv_name);
            timeTv = view.findViewById(R.id.item_mainlv_tv_time);
            moneyTv = view.findViewById(R.id.item_mainlv_tv_money);
            reasonTv = view.findViewById(R.id.item_mainlv_tv_reason);
        }
    }
}
